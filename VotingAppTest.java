				...
				try {
					...
					case 2:System.out.println("enter email and password");
					  ...
					  dao.getTwoCandidatesMaxVotes(sc.nextInt()).forEach(System.out::println);
						...
						break;
					case 3:System.out.println("For registeration : ");
					System.out.println("enter fist name, last name, email, password, date of birth(YYYY-MM-DD) : ");
					System.out.println(dao.registerNewUser(new User(sc.next(), sc.next(), sc.next(), sc.next(), Date.valueOf(sc.next()))));
						break;
